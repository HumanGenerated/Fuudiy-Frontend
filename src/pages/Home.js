...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const fetchFoods = async () => {
      try {
        setLoading(true);
        const response = await axios.get("https://fuudiy.com:8000/food/top-5-foods", {
        ...
        const response_by_country = await axios.get("https://fuudiy.com:8000/food/top-foods-by-country", {
          headers: { "Cache-Control": "no-cache" },
        });
